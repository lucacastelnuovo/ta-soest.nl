...
curl_setopt($curl, CURLOPT_POSTFIELDS, ['to' => 'info@ta-soest.nl', 'from_name' => 'Contactformulier || TA-Soest','subject' => 'Contactformulier || TA-Soest', 'body' => $body, 'api_key' => $config['api_key']]);
...
if ($result['status'] != 'true') {
    header('HTTP/1.1 400 Bad Request');
    header('Content-Type: application/json; charset=UTF-8');
    die(json_encode(array('message' => 'Uw bericht is niet verstuurd, probeer het later opnieuw')));
}
